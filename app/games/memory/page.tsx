...
import { ArrowLeft, Joystick, Trophy, Timer, Share2, Maximize2, CheckCircle2, Gamepad2, User, LayoutGrid } from "lucide-react";
...
export default function MemoryPage() {
    ...
    const leaderboard = [
        { rank: "01", name: "Mnemonica", region: "France", score: "45s", color: "text-amber-500", border: "border-amber-500" },
        { rank: "02", name: "Brainiac", region: "Korea", score: "48s", color: "text-slate-400", border: "border-slate-400" },
        { rank: "03", name: "TotalRecall", region: "Canada", score: "52s", color: "text-amber-700", border: "border-amber-700" },
    ];
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, ease: "easeOut" }} className="min-h-screen grid-bg pb-20">
                ...
                <div className="flex flex-col lg:flex-row gap-10">
                    ...
                    <div className="flex-1 space-y-10">
                        <div className="flex items-end justify-between border-b border-white/5 pb-6">
                            <div className="space-y-4">
                                ...
                                <h2 className="text-5xl md:text-6xl font-heading font-black uppercase italic tracking-tighter text-foreground">
                                    Memory <span className="text-primary">Matrix</span>
                                </h2>
                            </div>
                            <div className="text-right">
                                <span className="text-muted-foreground text-[10px] font-black uppercase tracking-widest">Speed Bonus</span>
                                <p className="text-amber-400 font-heading text-3xl font-black">2x XP</p>
                            </div>
                        </div>
                            ...
                            <div className="relative glass-card rounded-2xl overflow-hidden border-white/10">
                                ...
                                <div className="absolute top-8 left-8">
                                    <div className="bg-black/60 backdrop-blur-md px-4 py-1.5 rounded-lg border border-secondary/50 flex items-center gap-3">
                                        ...
                                        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-white">Neural Sync Ready</span>
                                    </div>
                                </div>
                                ...
                                <div className="absolute bottom-8 left-8 right-8 flex justify-between items-center">
                                    <div className="flex items-center gap-5">
                                        ...
                                        <div>
                                            <p className="text-white font-heading font-black tracking-wider">PATTERN ENGINE</p>
                                            <p className="text-muted-foreground text-[10px] font-black uppercase tracking-[0.3em] mt-1">v4.2 Cognitive Sync</p>
                                        </div>
                                    </div>
                        ...
                        <div className="space-y-6">
                            <h3 className="font-heading text-[10px] font-black uppercase tracking-[0.4em] text-muted-foreground">Select Neural Load</h3>
                            <div className="grid grid-cols-3 gap-6">
                                {[
                                    { id: "EASY", label: "Alpha", desc: "4x4 Grid • Slow", color: "emerald" },
                                    { id: "MEDIUM", label: "Beta", desc: "6x6 Grid • Fast", color: "amber" },
                                    { id: "HARD", label: "Omega", desc: "8x8 Grid • Hyper", color: "rose" }
                                ].map((opt) => (
                                    <button
                                        key={opt.id}
                        ...
                        <div className="glass-card rounded-2xl border-white/10 p-8 h-full flex flex-col">
                            <div className="flex items-center justify-between mb-10">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h3 className="font-heading font-black uppercase tracking-widest text-sm">Mind Masters</h3>
                                </div>
                                <span className="text-[9px] bg-primary/20 text-primary px-2.5 py-1 rounded-lg border border-primary/30 font-black tracking-widest">TOP TIMES</span>
                            </div>
                            ...
                            <div className="flex-1 space-y-4">
                                ...
                                <div className="space-y-4 mt-8 pt-8 border-t border-white/5">
                                    {[
                                        { rank: "04", name: "Cortex", score: "55s" },
                                        { rank: "05", name: "Synapse", score: "58s" },
                                        { rank: "06", name: "Dendrite", score: "62s" },
                                        { rank: "07", name: "Enigma", score: "65s" },
                                        { rank: "08", name: "Puzzler", score: "68s" },
                                    ].map((item, i) => (
                            ...
                            <div className="mt-10 pt-6 border-t border-white/5">
                                <div className="flex items-center gap-4 bg-primary/10 p-4 rounded-xl border border-primary/30">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-[9px] text-primary font-black uppercase tracking-[0.2em] mb-1">Your Neuron Rank</p>
                                        <p className="text-sm font-heading font-black text-white italic">#1,105</p>
                                    </div>
                                    <p className="text-[10px] font-black text-muted-foreground tracking-widest">72s BEST</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mt-20 flex flex-col items-center gap-8">
                    <button className="group relative px-24 py-8 bg-secondary rounded-xl text-background font-heading text-3xl font-black uppercase tracking-[0.3em] transition-all hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(34,211,238,0.5)]">
                        <span className="relative z-10 flex items-center gap-4">
                            SYNC MIND <Gamepad2 className="w-8 h-8" />
                        </span>
                    ...
                    <div className="flex gap-16 text-muted-foreground/60">
                        <div className="flex items-center gap-3">
                            <span className="text-secondary/50 font-black">MOUSE</span>
                            <span className="text-[10px] font-black uppercase tracking-widest">CLICK TILES</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <div className="px-2 py-0.5 border border-current rounded text-[10px]">T</div>
                            <span className="text-[10px] font-black uppercase tracking-widest">TOGGLE THEME</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <Timer className="w-4 h-4 text-secondary/50" />
                            <span className="text-[10px] font-black uppercase tracking-widest">AVG ROUND: 1M</span>
                        </div>
                    </div>
                </div>
            </main>
            ...
            <div className="fixed bottom-0 left-0 w-full px-12 py-6 pointer-events-none -z-10 opacity-10">
                <div className="flex justify-between items-end">
                    <div className="font-heading text-[120px] leading-none font-black tracking-tighter text-foreground select-none">MEMORY</div>
                    <div className="flex gap-4">
