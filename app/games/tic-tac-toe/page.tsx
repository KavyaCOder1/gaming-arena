...
import { ArrowLeft, Joystick, Trophy, Timer, Share2, Maximize2, CheckCircle2, Gamepad2, User, Grid3X3 } from "lucide-react";
...
export default function TicTacToePage() {
    ...
    const leaderboard = [
        { rank: "01", name: "X_Master", region: "Germany", score: "2,500", color: "text-amber-500", border: "border-amber-500" },
        { rank: "02", name: "O_King", region: "Japan", score: "2,230", color: "text-slate-400", border: "border-slate-400" },
        { rank: "03", name: "TicTacPro", region: "USA", score: "2,100", color: "text-amber-700", border: "border-amber-700" },
    ];
        ...
        <div className="min-h-screen grid-bg pb-20">
                    ...
                    <div className="flex-1 space-y-10">
                        <div className="flex items-end justify-between border-b border-white/5 pb-6">
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-amber-400 font-heading text-3xl font-black">200 XP</p>
                            </div>
                        </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative glass-card rounded-2xl overflow-hidden border-white/10">
                                <img
                                    ...
                                    src="https://images.unsplash.com/photo-1668901382969-8c73e450a1f5?q=80&w=1000&auto=format&fit=crop"
                                />
                                ...
                                <div className="absolute bottom-8 left-8 right-8 flex justify-between items-center">
                                    <div className="flex items-center gap-5">
                                        <div className="p-4 bg-slate-900/80 rounded-2xl border border-primary/30">
                                            <Grid3X3 className="w-8 h-8 text-primary shadow-glow" />
                                        </div>
                                        <div>
                                            <p className="text-white font-heading font-black tracking-wider">STRATEGY ENGINE</p>
                                            <p className="text-muted-foreground text-[10px] font-black uppercase tracking-[0.3em] mt-1">v2.0 Neural AI</p>
                                        </div>
                                    </div>
                        ...
                        <div className="space-y-6">
                            <h3 className="font-heading text-[10px] font-black uppercase tracking-[0.4em] text-muted-foreground">Select AI Intensity</h3>
                            <div className="grid grid-cols-3 gap-6">
                                {[
                                    { id: "EASY", label: "Novice", desc: "Basic AI • Random", color: "emerald" },
                                    { id: "MEDIUM", label: "Veteran", desc: "Adaptive AI • Smart", color: "amber" },
                                    { id: "HARD", label: "Master", desc: "Invincible AI • Neural", color: "rose" }
                                ].map((opt) => (
                                    <button
                                        key={opt.id}
                        ...
                        <div className="glass-card rounded-2xl border-white/10 p-8 h-full flex flex-col">
                            <div className="flex items-center justify-between mb-10">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h3 className="font-heading font-black uppercase tracking-widest text-sm">Top Architects</h3>
                                </div>
                                <span className="text-[9px] bg-primary/20 text-primary px-2.5 py-1 rounded-lg border border-primary/30 font-black tracking-widest">SEASON 1</span>
                            </div>
                            ...
                            <div className="flex-1 space-y-4">
                                ...
                                <div className="space-y-4 mt-8 pt-8 border-t border-white/5">
                                    {[
                                        { rank: "04", name: "AlphaZero", score: "1,980" },
                                        { rank: "05", name: "DeepBlue_Clone", score: "1,750" },
                                        { rank: "06", name: "LazyX", score: "1,600" },
                                        { rank: "07", name: "MatrixRunner", score: "1,450" },
                                        { rank: "08", name: "GridLord", score: "1,200" },
                                    ].map((item, i) => (
                            ...
                            <div className="mt-10 pt-6 border-t border-white/5">
                                <div className="flex items-center gap-4 bg-primary/10 p-4 rounded-xl border border-primary/30">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-[9px] text-primary font-black uppercase tracking-[0.2em] mb-1">Your Tactical Rank</p>
                                        <p className="text-sm font-heading font-black text-white italic">#842</p>
                                    </div>
                                    <p className="text-[10px] font-black text-muted-foreground tracking-widest">950 PTS</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mt-20 flex flex-col items-center gap-8">
                    <button className="group relative px-24 py-8 bg-secondary rounded-xl text-background font-heading text-3xl font-black uppercase tracking-[0.3em] transition-all hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(34,211,238,0.5)]">
                        <span className="relative z-10 flex items-center gap-4">
                            ENGAGE AI <Gamepad2 className="w-8 h-8" />
                        </span>
                    ...
                    <div className="flex gap-16 text-muted-foreground/60">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-widest">POINT & CLICK</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <div className="px-2 py-0.5 border border-current rounded text-[10px]">R</div>
                            <span className="text-[10px] font-black uppercase tracking-widest">RESET GRID</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <Timer className="w-4 h-4 text-secondary/50" />
                            <span className="text-[10px] font-black uppercase tracking-widest">AVG MATCH: 2M</span>
                        </div>
                    </div>
                </div>
            </main>
            ...
            <div className="fixed bottom-0 left-0 w-full px-12 py-6 pointer-events-none -z-10 opacity-10">
                <div className="flex justify-between items-end">
                    <div className="font-heading text-[120px] leading-none font-black tracking-tighter text-foreground select-none">TIC-TAC-TOE</div>
                    <div className="flex gap-4">
